document.addEventListener('DOMContentLoaded', () => {
  ...
  // 🔽 新增的「課程用書」項目
  {
    ...
    btn: "教材試閱",
    btnUrl: "https://roc-central-ai-edu.org/modules/tad_uploader/index.php?of_cat_sn=9"
  },

  // 🔽 新增的「課程介紹」項目
  {
    title: "課程介紹｜《懂行業 AI 的開發實務》（四堂 共12小時）",
    desc: "\n本培訓課程共四個單元，每單元 3 小時，合計 12 小時，採循序漸進方式，帶領學員完成一套真正可落地的行業型 AI 模型訓練流程。\n\n【上游建設｜3 小時】\n利用 LLM 訓練自己的行業性 AI 模型。\n• 收集領域（行業）型文件，如建築 BIM 文件。\n• 善用野貓 LLM（如 ChatGPT、DS）閱讀文件，萃取領域專業知識。\n• 建立領域型 seed-KG（行業種子知識圖）。\n• 使用 seed-KG 訓練家貓模型（GraphMERT）。\n\n【中游任務｜3 小時】\n利用自建的家貓模型，建立任務型知識圖並訓練 GNN。\n• 收集特定任務（應用）相關文件。\n• 透過 GraphMERT 萃取應用知識，建立任務型 task-KG。\n• 使用 task-KG 訓練 GNN 模型。\n\n【下游應用｜3 小時】\n將 GNN 模型正式置入數位孿生（DT）系統核心。\n• 將 GNN 模型植入 DT 系統核心架構。\n• 持續完善數位孿生系統功能。\n• 示範實際應用案例，建立可運作的智慧核心。\n\n【實戰應用｜3 小時】\n以 DT 與強化學習打造 AI 機器人的空間智慧。\n• 結合 DT 與強化學習，提供高階空間智慧能力。\n• 強化 AI 代理人（機器人）決策與行動能力。\n• 應用於醫療長照、無人機 UAV 等多元產業場景。",
    btn: "立即報名",
    btnUrl: "#"
  }
  ];
  ...
  wrap.innerHTML = `
    <div class="cl-container">
      <h2 class="cl-section-title">培訓課程資訊</h2>
      ${courseData.map(c => `
        <div class="cl-item">
